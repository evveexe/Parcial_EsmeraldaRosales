...
public class GameManager : MonoBehaviour
{
    ...
    public float tiempoEntreSpawnMin = .5f;
    public float tiempoEntreSpawnMax = 1.5f;
    private float timer;
    ...
    public int puntosParaReiniciarJuego = 5;
    ...
    void SpawnTarget()
    {
        ...
        GameObject oldTarget = GameObject.FindWithTag("Cubito");
        if (oldTarget != null)
        {
            Destroy(oldTarget);
        }
    ...
    {
        puntos++;
        contador.text = puntos + (" / " + puntosParaReiniciarJuego);
